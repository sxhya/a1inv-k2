...
We say that the Steinberg group functor $\St$ satisfies {\it Tulenbaev's lifting property} if
for every pair $(R, I)$ and every nonnilpotent $a \in R$ such that the localization map of modules $\lambda_a\colon I \rightarrow I_a$ is an isomorphism
the following lifting problem has a solution.
\[\begin{tikzcd} \St(R,   I) \arrow[r, "\mu"] \arrow[d, "\lambda_a^*"]          &  \St(R) \ar[d, "\lambda_a^*"] \\
