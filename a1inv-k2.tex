...
\begin{proof}
 First of all, notice that using Tulenbaev's lifting property~\ref{def:tlp} we find a map $\varphi$ such that $i_2^+ \varphi = \mu^\pm$.
...
\begin{proof}
 Follows from the above proposition by a simple diagram chasing (cf.~\cite[Cor.~4.2]{Tu}).
